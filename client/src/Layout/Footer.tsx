    ...
    <div className="sticky w-full min-h-max bg-gray-700 text-white top-0 z-5 mt-24 pb-3">
      <div className="w-full p-5 relative  flex justify-center">
        <div className="flex flex-row w-full">
          <ul className="flex flex-row justify-center p-3 w-full space-x-4 md:space-x-36">
            ...
            <li className="text-left space-y-2">
              ...
              <ul className="space-y-4 ">
                <li className="text-xl md:text-2xl">김형욱</li>
                <li className="text-xl md:text-2xl">박상은</li>
                <li className="text-xl md:text-2xl">이호승</li>
              </ul>
            </li>
            <li className="text-left space-y-2">
              <h3 className="font-bold">BACK-END</h3>
              <ul className="space-y-4">
                <li className="text-xl md:text-2xl">이미연</li>
                <li className="text-xl md:text-2xl">윤영우</li>
                <li className="text-xl md:text-2xl">임종영</li>
                <li className="text-xl md:text-2xl">홍승현</li>
              </ul>
            </li>
          </ul>
        </div>
