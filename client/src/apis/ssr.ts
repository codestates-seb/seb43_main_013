...
export const apiSSRFetchPromotionBoard: ApiFetchPromotionBoardHandler = async ({ promotionBoardId }) =>
  fetch(`${BASE_URL}/promotionboard/${promotionBoardId}`, {
    next: { revalidate: 3 },
  }).then((res) => res.json());
